...
const MainBody = ({ data, setData, basketCount, setBasketCount, basket, setBasket }) => {
    ...
    return (
        <section id='mainBody'>
            ...
            <div className="container cardHodler">
                <Cards data={filteredData} setData={setData} basketCount={basketCount} setBasketCount={setBasketCount} basket={basket} setBasket={setBasket} />
            </div>
        </section>
    );
};
