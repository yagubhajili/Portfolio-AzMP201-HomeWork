            ...
            <div className="max-w-sm mx-auto">
                ...
                <div className="mb-5">
                    ...
                    <input
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required=""
                        value={productToEdit.contactName}
                        onChange={e => {
                            setProductToEdit({ ...productToEdit, contactName: e.target.value })
                        }}
                    />
                </div>
                <div className="mb-5">
                    ...
                    <input
                        ...
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        required=""
                        value={productToEdit.address.city}
                        onChange={e => {
                            setProductToEdit({ ...productToEdit, address: { city: e.target.value } })
                        }}
                    />
                </div>
                <div className="mb-5">
                    ...
                    <input
                        ...
                        value={productToEdit.address.city}
                        onChange={e => {
                            setProductToEdit({ ...productToEdit, address: { region: e.target.value } })
                        }}
                    />
                </div>
                <button
                    onClick={() => {
                        axios.patch(`${BASE_URL}${endPoints.suppliers}${supplierId}`, { ...productToEdit })
                    }}
                    type="submit"
